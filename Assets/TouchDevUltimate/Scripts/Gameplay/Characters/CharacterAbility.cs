...
namespace TouchDevUltimate.Gameplay.Character
{
    public abstract class CharacterAbility : MonoBehaviour, IButtonListener, IJoystickListener, IGestureListener
    {
        ...
        public virtual void OnButton(string name, InputState state)
        {

        }

        public virtual void OnJoystick(string name, Vector2 direction, InputState state)
        {

        }

        public virtual void OnGesture(string name, GestureType type)
        {
